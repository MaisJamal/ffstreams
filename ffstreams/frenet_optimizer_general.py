...
#####
D_T_S = config['d_t_s']  # target speed sampling length [m/s]
N_S_SAMPLE = config['n_s_sample']  # sampling number of target speed
...
def get_traj_follow_speed_general(ego_state,target_speed,wx,wy):
